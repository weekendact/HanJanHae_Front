...
import 'package:hanjanhae/pages/CommunityPage.dart';
...
class _homepageState extends State<homepage> {
  ...
  Widget cocktailcard() {
    return ListView(
      ...
      children: [
        _buildCocktailCard(context, 'assets/req/cocktail1.jpg', "칵테일1", 0),
        _buildCocktailCard(context, 'assets/req/cocktail1.jpg', "칵테일2", 1),
        _buildCocktailCard(context, 'assets/req/cocktail1.jpg', "칵테일3", 2),
        _buildCocktailCard(context, 'assets/req/cocktail1.jpg', "칵테일4", 3),
        _buildCocktailCard(context, 'assets/req/cocktail1.jpg', "칵테일5", 4),
      ],
    );
  }
}
